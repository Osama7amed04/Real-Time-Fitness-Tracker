...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            if torso_angle_l > 60:
                is_valid_l = False
                state["error_msg"] = "BEND OVER FOR REAR DELT L!"
                state["error_time"] = cur_time
            if torso_angle_r > 60:
                is_valid_r = False
                state["error_msg"] = "BEND OVER FOR REAR DELT R!"
                state["error_time"] = cur_time
            ...
            cv2.putText(image, "REAR DELT", (150, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
        ...
        cv2.imshow("REAR DELT TRACKER", image)
