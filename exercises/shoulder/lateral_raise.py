    ...
    while cap.isOpened():
        ...
        try:
            ...
            if torso_angle_r < 60:
                ...
                state["error_time"] = cur_time
            if abs(l_el[0] - l_sh[0]) < 0.05 and angle_l > 40:
                is_valid_l = False
                state["error_msg"] = "MOVE ARM OUTWARDS L!"
                state["error_time"] = cur_time
            if abs(r_el[0] - r_sh[0]) < 0.05 and angle_r > 40:
                is_valid_r = False
                state["error_msg"] = "MOVE ARM OUTWARDS R!"
                state["error_time"] = cur_time
            ...
            cv2.putText(image, "LATERAL RAISE", (150, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2)
